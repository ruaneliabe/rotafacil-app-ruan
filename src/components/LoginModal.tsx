    ...
    <div className={outerClasses}>
      <div className="bg-white text-slate-900 rounded-2xl max-w-md w-full p-6 shadow-xl border border-slate-200 space-y-5">
        ...
        <div className="text-center space-y-1.5">
          <div className="w-14 h-14 rounded-2xl bg-slate-900 text-white flex items-center justify-center text-3xl font-black mx-auto shadow-md">
            🛵
          </div>
          <div>
            ...
            <p className="text-xs font-extrabold text-slate-600 tracking-wide uppercase">
        ...
        {activeRole === 'store_admin' && (
          <form onSubmit={handleStoreLogin} className="space-y-4 text-xs">
            ...
            <button
              type="submit"
              className="w-full py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl transition-all shadow-xs flex items-center justify-center gap-2 text-xs uppercase cursor-pointer"
            >
        ...
        {activeRole === 'motoboy' && (
          <form onSubmit={handleMotoboyLogin} className="space-y-4 text-xs">
            <div className="space-y-1">
              <label className="font-bold text-slate-700 block">Código do Motoboy ou Nome Cadastrado</label>
              <div className="relative">
                <User className="w-4 h-4 text-slate-400 absolute left-3 top-2.5" />
                <input
                  type="text"
