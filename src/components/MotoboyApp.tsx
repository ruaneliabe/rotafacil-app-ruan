...
const isFinalized=(o:Order)=>{const anyOrder=o as any;return o.status==='delivered'||o.status==='cancelled'||Boolean(o.deliveredTimestamp)||Boolean(o.deliveredAt)||Boolean(o.deliveredDate)||anyOrder.closedInCardapioWeb===true||Boolean(anyOrder.closedAt)};
const isDelivered=(o:Order)=>{const anyOrder=o as any;return o.status==='delivered'||Boolean(o.deliveredTimestamp)||Boolean(o.deliveredAt)||Boolean(o.deliveredDate)||anyOrder.closedInCardapioWeb===true||Boolean(anyOrder.closedAt)};
...
export const MotoboyApp:React.FC<P>=({motoboys,orders,shift,onUpdateOrderStatus,onSimulateArrival,onReorderMotoboyRoute,onConfirmArrivalAtStore,onUpdateMotoboyStatus,initialMotoboyId,isLockedToMotoboy=false,onLogout})=>{
  ...
  const startNext=(o:Order)=>{onUpdateOrderStatus(o.id,'in_transit')};
